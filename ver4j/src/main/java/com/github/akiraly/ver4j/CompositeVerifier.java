...
public class CompositeVerifier {
	...
	public <C> C argInstanceOf(Object instance, Object name, Class<C> clazz) {
		return argV.instanceOf(instance, name, clazz);
	}

	public <C> C varInstanceOf(Object instance, Object name, Class<C> clazz) {
		return varV.instanceOf(instance, name, clazz);
	}

	public <C> C fieldInstanceOf(Object instance, Object name, Class<C> clazz) {
		return fieldV.instanceOf(instance, name, clazz);
	}

	public <C> C stateInstanceOf(Object instance, Object name, Class<C> clazz) {
		return stateV.instanceOf(instance, name, clazz);
	}

	public <C> C resultInstanceOf(Object instance, Object name, Class<C> clazz) {
		return resultV.instanceOf(instance, name, clazz);
	}
}
